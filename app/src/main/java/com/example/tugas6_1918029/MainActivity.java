package com.example.tugas6_1918029;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void startOneTimeTask(){
        ...
        Data data = new Data.Builder()
                .putString(Weather.EXTRA_CITY,spCity.getSelectedItem().toString())
                .build();
        ...
        OneTimeWorkRequest oneTimeWorkRequest = new OneTimeWorkRequest.Builder(Weather.class)
                .setInputData(data)
    ...
    private void startPeriodicTask(){
        ...
        periodicWorkRequest = new PeriodicWorkRequest.Builder(Weather.class, 15, TimeUnit.MINUTES)
                .setInputData(data)
                .setConstraints(constraints)
                .build();
